...
<body>
    <div class="bungkus">
        ...
        <div class="tengah">
            ...
            <div class="back">
                <img id="back" src="aset/left-arrow.png">
            </div>

            <img id="fotoku" src="aset/agustd.jpeg">

            <p class="username">@riaamariaa1730</p>
            <p class="nickname">riaa</p>

            <p class="bioProfil">lil meow</p>
            <p class="from">Kota Surabaya, Jawa Timur</p>
            <p class="joinPada">Joined April 2023</p>

            <div>
                <button class="editProfil">
                    <h4 id="edit">Edit Profile</h4>
                </button>
            </div>

            <div class="lokasi">
                <img id="logoLokasi" src="aset/pin (1).png">
            </div>

            <div class="kalendar">
                <img id="logoKalender" src="aset/calendar (1).png">
            </div>

            <div class="following_followers">
                <p class="jumlahFollowers">20</p>
                <p class="followers">Followers</p>

                <p class="jumlahMengikuti">0</p>
                <p class="following">Following</p>
            </div>

            <div class="kolomKonten">
                <h4 class="posts">Posts</h4>
                <h4 class="replies">Replies</h4>
